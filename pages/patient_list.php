                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="patientList">
                                <thead>
                                    <tr>
                                        <th> SL </th>
                                        <th> Image </th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bolder" id="exampleModalLabel">Patient Details</h1>
                ...
                <div class="modal-body text-center">
                    <div class="details" id="patDtls">
                        ...
                        <h4 class="mt-2 fw-bolder">State: West Bengal</h4>
                        <h4 class="mt-2 fw-bolder">PIN Code: 743423</h4>
